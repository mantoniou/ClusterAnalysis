...
Below there is a heatmap plot with **information about all clusters**, indicating the 
...
segment_countries %>%
  ...
  select("n", 3:ncol(final))

rownames(heatmap) <- c("A", "B") 
  
library(d3heatmap)

  heatmap %>% 
  d3heatmap(scale = "column", dendrogram = "both", color = "Blues",
            cexRow = .7)
```
